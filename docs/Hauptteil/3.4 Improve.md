...
Damit keine Excel-Liste mehr geführt werden muss, habe ich ein *Camunda-Forms* erstellt, in welchem man in 2 Tasks Informationen abfüllen muss. Das *Forms* sieht wie folgt aus:
![Forms](../../ressources/bilder/Form.png)

Um die Symbole zu verstehen, dient folgende Quelle.
[Quelle](../Quellenverzeichnis/index.md#camunda-symbole)